...
project: 项目/gNT计算机制
name: html-ppt
description: HTML PPT Studio — 专业静态HTML演示文稿制作工具，36种主题、15套模板、31种布局、27种CSS动画。用于制作PPT、幻灯片、演讲稿、小红书图文等。
  — author professional static HTML presentations in many styles, layouts, and animations,
  all driven by templates. Use when the user asks for a presentation, PPT, slides,
  keynote, deck, slideshow, "幻灯片", "演讲稿", "做一份 PPT", "做一份 slides", a reveal-style
  HTML deck, a 小红书 图文, or any kind of multi-slide pitch/report/sharing document that
  should look tasteful and be usable with keyboard navigation. Triggers include keywords
  like "presentation", "ppt", "slides", "deck", "keynote", "reveal", "slideshow",
  "幻灯片", "演讲稿", "分享稿", "小红书图文", "talk slides", "pitch deck", "tech sharing", "technical
  presentation".
updated: '2026-07-02'
_original_tags:
- 领域/计算机制
...
- ppt
- 技能文档
summary: HTML PPT Studio的安装和使用说明
---
